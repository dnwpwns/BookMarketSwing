...
public class CartOrderBillPage extends JPanel {
    ...
    // ✅ 생성자에 주소 추가
    public CartOrderBillPage(JPanel panel, Cart cart, String address) {
        ...
        printBillInfo(UserInIt.getmUser().getName(),
                      String.valueOf(UserInIt.getmUser().getPhone()),
                      address);
    }
    ...
    public static void main(String[] args) {
        ...
        BookInIt.init();
        mPagePanel.add("주문하기", new CartOrderBillPage(mPagePanel, mCart, "서울특별시 강남구 역삼동"));
